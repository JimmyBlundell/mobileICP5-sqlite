...
public class EmployerActivity extends AppCompatActivity {
    ...
    private void saveToDB() {
        ...
        database.insert(SampleDBContract.Employer.TABLE_NAME, null, values);
    ...
    private void updateFromDB() {
        ...
        vals.put(SampleDBContract.Employer.COLUMN_NAME, binding.nameEditText.getText().toString());
        vals.put(SampleDBContract.Employer.COLUMN_DESCRIPTION, binding.descEditText.getText().toString());
        String clause = SampleDBContract.Employer.COLUMN_NAME + " like ?";
        String[] args = {"%" + binding.nameEditText.getText().toString() + "%"};
        db.update(SampleDBContract.Employer.TABLE_NAME,vals,clause,args);
        Toast.makeText(this, "Updated " + binding.nameEditText.getText().toString(), Toast.LENGTH_LONG).show();
        readFromDB();
    }
    ...
    private void deleteFromDB() {
        ...
        String name = binding.nameEditText.getText().toString();
        String desc = binding.descEditText.getText().toString();
        String clause = SampleDBContract.Employer.COLUMN_NAME + " like ? AND " + SampleDBContract.Employer.COLUMN_DESCRIPTION + " like ?";
        String[] args = {"%" + name + "%", "%" + desc + "%"};
        database.delete(SampleDBContract.Employer.TABLE_NAME, clause, args);
